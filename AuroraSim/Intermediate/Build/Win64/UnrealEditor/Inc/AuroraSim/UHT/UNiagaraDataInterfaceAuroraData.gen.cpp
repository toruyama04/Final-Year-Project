...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUNiagaraDataInterfaceAuroraData_Statics::NewProp_EmitterOrigin = { "EmitterOrigin", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUNiagaraDataInterfaceAuroraData, EmitterOrigin), Z_Construct_UScriptStruct_FVector3f, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EmitterOrigin_MetaData), NewProp_EmitterOrigin_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUNiagaraDataInterfaceAuroraData_Statics::NewProp_EmitterSize = { "EmitterSize", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUNiagaraDataInterfaceAuroraData, EmitterSize), Z_Construct_UScriptStruct_FVector3f, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EmitterSize_MetaData), NewProp_EmitterSize_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_toruy_iu_Documents_Y3_Modules_FYP_AuroraSim_AuroraSim_Source_AuroraSim_Public_UNiagaraDataInterfaceAuroraData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUNiagaraDataInterfaceAuroraData, UUNiagaraDataInterfaceAuroraData::StaticClass, TEXT("UUNiagaraDataInterfaceAuroraData"), &Z_Registration_Info_UClass_UUNiagaraDataInterfaceAuroraData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUNiagaraDataInterfaceAuroraData), 4284183898U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_toruy_iu_Documents_Y3_Modules_FYP_AuroraSim_AuroraSim_Source_AuroraSim_Public_UNiagaraDataInterfaceAuroraData_h_259223889(TEXT("/Script/AuroraSim"),
